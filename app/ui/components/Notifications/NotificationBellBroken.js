...
const NotificationBell = props => {
  ...
  console.log('first notification seen: ', notifications[0].notificationSeen);
...
class StatefullBell extends React.Component {
  shouldComponentUpdate(nextProps) {
    return true;
  }

  render() {
    return <NotificationBell {...this.props} />;
  }
}

export default StatefullBell;
