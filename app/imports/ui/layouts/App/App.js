...
const App = (props) => {
  const paths = () =>
    ...
    [
      ...
      <AppRoute key="/legal" distractionFree path="/legal" title="Legal" exact component={DeferredComponent} loadingComponent={<LoadingComponent />} importFunction={() => import('/imports/ui/screens/Legal/Legal.js')} {...props} />,
...
export default withTracker(() => {
  ...
  const handle = { ready() { return true; } };
  // if (userId) {
